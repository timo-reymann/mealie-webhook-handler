...
[![Docker Pulls](https://img.shields.io/docker/pulls/timoreymann/mealie-webhook-handler?style=flat)](https://hub.docker.com/r/timoreymann/mealie-webhook-handler)
[![GitHub all releases download count](https://img.shields.io/github/downloads/timo-reymann/mealie-webhook-handler/total)](https://github.com/timo-reymann/mealie-webhook-handler/releases)
...
[![codecov](https://codecov.io/gh/timo-reymann/mealie-webhook-handler/graph/badge.svg?token=lTQRwxnxYl)](https://codecov.io/gh/timo-reymann/mealie-webhook-handler)
[![Quality Gate Status](https://sonarcloud.io/api/project_badges/measure?project=timo-reymann_mealie-webhook-handler&metric=alert_status)](https://sonarcloud.io/summary/new_code?id=timo-reymann_mealie-webhook-handler)
[![Maintainability Rating](https://sonarcloud.io/api/project_badges/measure?project=timo-reymann_mealie-webhook-handler&metric=sqale_rating)](https://sonarcloud.io/summary/new_code?id=timo-reymann_mealie-webhook-handler)
[![Security Rating](https://sonarcloud.io/api/project_badges/measure?project=timo-reymann_mealie-webhook-handler&metric=security_rating)](https://sonarcloud.io/summary/new_code?id=timo-reymann_mealie-webhook-handler)
...
**Key Use Case**:
Automate syncing Mealie recipes to a Chowdown-compatible GitHub repo (or other targets) with minimal manual effort.
